...
const features = [
  ...
  },
  {
    ...
    description: 'Menyusun narasi laporan statistik resmi secara otomatis dari data Satu Data Aceh menggunakan AI generatif.',
  },
  {
          ...
          <section className="bg-white border border-gray-200 rounded-[32px] p-8 md:p-14 shadow-sm">
            <div className="max-w-3xl">
              ...
              <button
                ...
                onClick={() => setPage('trend')}
              >
                <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M5 13l4 4L19 7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" />
                </svg>
                AI Prediksi Tren Data
              </button>
            </div>
          </section>
            ...
            {features.map((feature) => (
              <div key={feature.title} className="bg-white border border-gray-200 rounded-[28px] p-6 flex flex-col h-full shadow-sm">
                ...
                <button
                  ...
                  onClick={() => {
                    if (feature.title === 'AI Prediksi Tren Data') {
                      setPage('trend')
                    }
                  }}
                >
