    ...
    <div className="min-h-screen bg-gray-50 text-slate-900">
      <header className="border-b border-gray-200 bg-white sticky top-0 z-20">
        <div className="max-w-6xl mx-auto px-4 py-4 flex flex-wrap items-center justify-between gap-4">
          <div>
            <span className="text-sm font-semibold uppercase text-red-700">SADA-AI</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-4 py-12 space-y-10">
        <section className="bg-white border border-gray-200 rounded-[32px] p-8 md:p-14 shadow-sm">
          <div className="max-w-3xl">
            ...
            <button className="bg-red-700 text-white px-6 py-4 rounded-full inline-flex items-center gap-3 hover:bg-red-800 transition-colors text-base font-semibold">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
          {features.map((feature) => (
            <div key={feature.title} className="bg-white border border-gray-200 rounded-[28px] p-6 flex flex-col h-full shadow-sm">
              ...
              <div className="inline-flex items-center text-sm font-semibold border border-gray-200 rounded-full px-4 py-2 text-slate-700 justify-center">
                Buka Fitur
              </div>
            </div>
          ))}
